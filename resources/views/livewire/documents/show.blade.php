<x-layouts.app>
    ...
    <div class="card w-auto mx-auto shadow-lg p-3 mb-4 bg-body rounded border border-dark">
        ...
        <table class="table table-striped table-hover">
            <thead class="text-center table-dark align-middle border border-dark">
            ...
            <tbody class="align-middle">
                ...
                <tr class="text-center">
                    ...
                    <td class="border border-dark">{{ $document->document_type }}</td>
                    <td class="text-center border border-dark">{{ $document->date }}</td>
                    ...
                    <td class="text-center border border-dark">{{ $document->updated_at }}</td>
                    <td class="text-center border border-dark">{{ $document->created_at }}</td>
